...
<div class="container">
    <div class="wrapper">
        ...
        if (!isset($_GET['IdPracownik'])
            ...
            print("<div class='add'>");
            print("<p class='msg error data'>Nie można usunąć danych pracownika, poniewaz są niekompletne lub błędne..</p>");
            ...
            if (isset($polaczenie) && ($polaczenie != null)) {
                try {  // Jeżeli polączenie zostało nawiązane.
//          print("<p class='msg success'>Połączenie z serwerem baz danych $serwer OK.</p>");
                    ...
                    $sql = "EXECUTE dbo.Pracownik_Usun
                    ...
                    if ($komenda_sql->rowCount() != 1) {
                        ...
                        print("<div class='add'>");
                        print("<p class='msg success'>Dane pracownika <strong>$IdPracownik</strong> zostały usunięte z bazy.</p>");
                        print("<button class='btn add' onclick='window.location.href = \"tabela.php\";'>Wróć</button>");
                        print("</div>");
                    }
